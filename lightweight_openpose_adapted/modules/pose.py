...
from lightweight_openpose_adapted.modules.keypoints import BODY_PARTS_KPT_IDS, BODY_PARTS_PAF_IDS
from lightweight_openpose_adapted.modules.one_euro_filter import OneEuroFilter
